...
export default function AddLaundryPaymentForm({ formId, branchId, order, onSubmit }: Props) {
  ...
  return (
    ...
    >
      <div className="rounded-lg border border-slate-200 bg-slate-50 px-3 py-2 text-sm text-slate-600">
        Order: <span className="font-medium text-slate-900">{order.order_reference}</span>
      </div>
